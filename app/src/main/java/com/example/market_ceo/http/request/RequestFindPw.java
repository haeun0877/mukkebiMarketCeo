...
public class RequestFindPw extends HttpApiRequest<JSONObject> {
    ...
    public RequestFindPw(Context context) {
        super(context);
    }
    ...
    public String getUrl() {
        return Constant.HTTP_API_BASE_URL + "cmk010_find_password.php";
    }
